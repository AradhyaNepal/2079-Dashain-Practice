class Constant{
  ...
  static const String howAppWorks="1) In Edit: User can insert, delete, watch and update all stored videos and can set repetition of those videos.\n\n"
      ...
      "3) In Play's Setting: User can choose for how much timeframe all videos are supposed to be played.\n\n"
      "4) In Play & Its Setting: User can't skip any video. They have to watch Everything, but they can reset the timeframe to make algorithm make playlist again";
